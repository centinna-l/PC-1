...
public class Date {
    ...
    public Date(int monthInt, int day, int year) // parameterized constructor
    {
        setDate(monthInt, day, year); // invoke another method (setDate)
    }

    public Date(String monthString, int day, int year) // parameterized constructor
    {
    ...
    public Date(int year) // parameterized constructor
    {
        setDate(1, 1, year);
    }

    public Date(Date aDate) // Copy constructor
    {
